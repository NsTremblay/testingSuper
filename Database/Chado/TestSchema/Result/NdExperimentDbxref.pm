use utf8;
package Database::Chado::TestSchema::Result::NdExperimentDbxref;
...
Database::Chado::TestSchema::Result::NdExperimentDbxref - Cross-reference experiment to accessions, images, etc
