use utf8;
package Database::Chado::TestSchema::Result::Assayprop;
...
Database::Chado::TestSchema::Result::Assayprop - Extra assay properties that are not accounted for in assay.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:4PJVxfS59Y3QQT+1zQ5KXA
