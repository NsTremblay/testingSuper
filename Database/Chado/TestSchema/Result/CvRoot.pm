use utf8;
package Database::Chado::TestSchema::Result::CvRoot;
...
Database::Chado::TestSchema::Result::CvRoot
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:HjvpMMKXY/xcgyoHHZ/OfA
