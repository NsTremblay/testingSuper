use utf8;
package Database::Chado::TestSchema::Result::NdExperimentPub;
...
Database::Chado::TestSchema::Result::NdExperimentPub - Linking nd_experiment(s) to publication(s)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:0Y7XWgerNoZYCTkri8njpQ
