use utf8;
package Database::Chado::TestSchema::Result::CommonAncestorCvterm;
...
Database::Chado::TestSchema::Result::CommonAncestorCvterm
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:RbezYt7aj8ZLKhVXS4a+WA
