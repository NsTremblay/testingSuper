use utf8;
package Database::Chado::TestSchema::Result::CvLeaf;
...
Database::Chado::TestSchema::Result::CvLeaf
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:SLHn4y6cxLtiVnEL+AAnSg
