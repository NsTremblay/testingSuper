use utf8;
package Database::Chado::TestSchema::Result::Organismprop;
...
Database::Chado::TestSchema::Result::Organismprop - Tag-value properties - follows standard chado model.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nwvwCk9Q0yzXdUWwcBOFwQ
