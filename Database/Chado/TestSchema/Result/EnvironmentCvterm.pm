use utf8;
package Database::Chado::TestSchema::Result::EnvironmentCvterm;
...
Related object: L<Database::Chado::TestSchema::Result::Environment>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:yQOH0K026lJpaSPtDUwUkg
