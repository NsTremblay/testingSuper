use utf8;
package Database::Chado::TestSchema::Result::NdExperimentProtocol;
...
Database::Chado::TestSchema::Result::NdExperimentProtocol - Linking table: experiments to the protocols they involve.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:mjKFai7S4NfU/z5rzlDZKw
