use utf8;
package Database::Chado::TestSchema::Result::FeatureIntersection;
...
Database::Chado::TestSchema::Result::FeatureIntersection
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nWNtLzYmwwkzQdWMlwMwDA
