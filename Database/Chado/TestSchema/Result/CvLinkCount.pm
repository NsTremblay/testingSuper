use utf8;
package Database::Chado::TestSchema::Result::CvLinkCount;
...
Database::Chado::TestSchema::Result::CvLinkCount
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VYI8NE9FCw7EDCBJcKR3aQ
