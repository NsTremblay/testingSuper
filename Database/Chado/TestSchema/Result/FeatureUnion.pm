use utf8;
package Database::Chado::TestSchema::Result::FeatureUnion;
...
Database::Chado::TestSchema::Result::FeatureUnion
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:PDEq4pzdVXT/vDzIQfHQFg
