use utf8;
package Database::Chado::TestSchema::Result::FeatureContains;
...
Database::Chado::TestSchema::Result::FeatureContains
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:Td33P509PKa5hW0r2eRSnA
