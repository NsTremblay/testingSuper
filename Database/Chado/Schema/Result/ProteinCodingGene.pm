use utf8;
package Database::Chado::Schema::Result::ProteinCodingGene;
...
Database::Chado::Schema::Result::ProteinCodingGene
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:s/1DvcIvwO99bIiIo7P7Cw
