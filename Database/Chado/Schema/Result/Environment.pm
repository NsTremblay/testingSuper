use utf8;
package Database::Chado::Schema::Result::Environment;
...
Database::Chado::Schema::Result::Environment - The environmental component of a phenotype description.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OY56cqqKeF8m5ZRdSKOOVA
