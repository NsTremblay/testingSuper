use utf8;
package Database::Chado::Schema::Result::TmpCoreAlignment;
...
Database::Chado::Schema::Result::TmpCoreAlignment
...
=head1 TABLE: C<tmp_core_alignment>

=cut

__PACKAGE__->table("tmp_core_alignment");
...
=head2 C<tmp_core_alignment_name_key>
