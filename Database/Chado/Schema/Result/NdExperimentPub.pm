use utf8;
package Database::Chado::Schema::Result::NdExperimentPub;
...
Database::Chado::Schema::Result::NdExperimentPub - Linking nd_experiment(s) to publication(s)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JOuBO5JejJJjTRWhvydZWA
