use utf8;
package Database::Chado::Schema::Result::ProjectContact;
...
Database::Chado::Schema::Result::ProjectContact - Linking project(s) to contact(s)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:5x6YC8LweUSX33d01OmHOg
