use utf8;
package Database::Chado::Schema::Result::Protocol;
...
Database::Chado::Schema::Result::Protocol - Procedural notes on how data was prepared and processed.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:8uNz5fwThTwvE/INq+f7AA
