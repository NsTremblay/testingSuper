use utf8;
package Database::Chado::TestSchema::Result::StatsPathToRoot;
...
Database::Chado::TestSchema::Result::StatsPathToRoot
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:VYev0wtFJ+JuqmSCFR7cAg
