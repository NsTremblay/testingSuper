use utf8;
package Database::Chado::TestSchema::Result::AssayBiomaterial;
...
Related object: L<Database::Chado::TestSchema::Result::Channel>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lrVVnjLd4E17VtAXl6dxsw
