use utf8;
package Database::Chado::TestSchema::Result::FeatureDifference;
...
Database::Chado::TestSchema::Result::FeatureDifference
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:fV38rItQaXZCXf53417/JQ
