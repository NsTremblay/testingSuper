use utf8;
package Database::Chado::TestSchema::Result::FeatureMeetsOnSameStrand;
...
Database::Chado::TestSchema::Result::FeatureMeetsOnSameStrand
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DlIYqJtYS4Ib562IQ0SGlA
