use utf8;
package Database::Chado::TestSchema::Result::ExpressionImage;
...
Related object: L<Database::Chado::TestSchema::Result::Eimage>

=cut

__PACKAGE__->belongs_to(
  "eimage",
  "Database::Chado::TestSchema::Result::Eimage",
  { eimage_id => "eimage_id" },
...
Related object: L<Database::Chado::TestSchema::Result::Expression>

=cut

__PACKAGE__->belongs_to(
  "expression",
  "Database::Chado::TestSchema::Result::Expression",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:cFLI9UErs1WxyhzdljI2lQ
