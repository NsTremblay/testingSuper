use utf8;
package Database::Chado::TestSchema::Result::Dbxref;
...
Related object: L<Database::Chado::TestSchema::Result::Biomaterial>
...
Related object: L<Database::Chado::TestSchema::Result::Db>

=cut

__PACKAGE__->belongs_to(
  "db",
  "Database::Chado::TestSchema::Result::Db",
  { db_id => "db_id" },
...
Related object: L<Database::Chado::TestSchema::Result::FeatureCvtermDbxref>

=cut

__PACKAGE__->has_many(
  "feature_cvterm_dbxrefs",
  "Database::Chado::TestSchema::Result::FeatureCvtermDbxref",
  { "foreign.dbxref_id" => "self.dbxref_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Database::Chado::TestSchema::Result::OrganismDbxref>

=cut

__PACKAGE__->has_many(
  "organism_dbxrefs",
  "Database::Chado::TestSchema::Result::OrganismDbxref",
  { "foreign.dbxref_id" => "self.dbxref_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
Related object: L<Database::Chado::TestSchema::Result::PhylonodeDbxref>

=cut

__PACKAGE__->has_many(
  "phylonode_dbxrefs",
  "Database::Chado::TestSchema::Result::PhylonodeDbxref",
  { "foreign.dbxref_id" => "self.dbxref_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:96QF6hSEzv28BoLk4AwMIg
