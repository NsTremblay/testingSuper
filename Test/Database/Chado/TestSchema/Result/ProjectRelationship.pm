use utf8;
package Database::Chado::TestSchema::Result::ProjectRelationship;
...
Database::Chado::TestSchema::Result::ProjectRelationship - A project can be composed of several smaller scale projects
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:CJy3/7RszRF65NEhng2B6g
