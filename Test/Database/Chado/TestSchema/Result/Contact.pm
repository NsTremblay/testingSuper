use utf8;
package Database::Chado::TestSchema::Result::Contact;
...
Database::Chado::TestSchema::Result::Contact - Model persons, institutes, groups, organizations, etc.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:szSs8mEjZ//k969BTgNO8A
