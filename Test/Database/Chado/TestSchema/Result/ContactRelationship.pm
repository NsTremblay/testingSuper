use utf8;
package Database::Chado::TestSchema::Result::ContactRelationship;
...
Database::Chado::TestSchema::Result::ContactRelationship - Model relationships between contacts
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:FxWXkwkdz1ExFrRzdRJZrA
