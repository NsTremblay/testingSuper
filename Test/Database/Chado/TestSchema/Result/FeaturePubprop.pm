use utf8;
package Database::Chado::TestSchema::Result::FeaturePubprop;
...
Database::Chado::TestSchema::Result::FeaturePubprop - Property or attribute of a feature_pub link.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:xIPrwyyPigUOmMLe75L8pA
