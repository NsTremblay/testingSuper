use utf8;
package Database::Chado::TestSchema::Result::CvPathCount;
...
Database::Chado::TestSchema::Result::CvPathCount
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:O6Rscw9xKpUDD76CSnA0oA
