use utf8;
package Database::Chado::TestSchema::Result::NdProtocolprop;
...
Database::Chado::TestSchema::Result::NdProtocolprop - Property/value associations for protocol.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ziamg50utrRcwicsHGAAjw
