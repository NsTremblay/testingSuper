use utf8;
package Database::Chado::TestSchema::Result::NdExperimentStockDbxref;
...
Database::Chado::TestSchema::Result::NdExperimentStockDbxref - Cross-reference experiment_stock to accessions, images, etc
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:f7/eWTQfmdLDIOlQSFGOtw
