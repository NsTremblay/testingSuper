use utf8;
package Database::Chado::TestSchema::Result::Assay;
...
Related object: L<Database::Chado::TestSchema::Result::StudyAssay>

=cut

__PACKAGE__->has_many(
  "study_assays",
  "Database::Chado::TestSchema::Result::StudyAssay",
  { "foreign.assay_id" => "self.assay_id" },
  { cascade_copy => 0, cascade_delete => 0 },
);
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:9R5dFlGrxbJ77a8pZHR4XA
