use utf8;
package Database::Chado::TestSchema::Result::ProjectPub;
...
Database::Chado::TestSchema::Result::ProjectPub - Linking project(s) to publication(s)
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ZJlQU5Sc+xn2Xiwa1C8xxQ
