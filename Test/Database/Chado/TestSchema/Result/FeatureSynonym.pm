use utf8;
package Database::Chado::TestSchema::Result::FeatureSynonym;
...
Database::Chado::TestSchema::Result::FeatureSynonym - Linking table between feature and synonym.
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:avSxSxFqqH2g03CzrSrScg
