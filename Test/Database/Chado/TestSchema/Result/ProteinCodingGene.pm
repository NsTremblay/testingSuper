use utf8;
package Database::Chado::TestSchema::Result::ProteinCodingGene;
...
Database::Chado::TestSchema::Result::ProteinCodingGene
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OVIZlnaQSjos/8uAckG2Pw
