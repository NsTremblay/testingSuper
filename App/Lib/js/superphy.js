...
(function() {
  ...
  ViewController = (function() {
    ...
    ViewController.prototype.init = function(publicGenomes, privateGenomes, _at_actionMode, _at_action, subset) {
      this.actionMode = _at_actionMode;
  ...
  ViewTemplate = (function() {
    function ViewTemplate(_at_parentElem, _at_style, _at_elNum) {
      this.parentElem = _at_parentElem;
      this.style = _at_style != null ? _at_style : 'select';
      this.elNum = _at_elNum != null ? _at_elNum : 1;
  ...
  ListView = (function(_super) {
    ...
    function ListView(_at_parentElem, _at_style, _at_elNum, listArgs) {
      this.parentElem = _at_parentElem;
  ...
  GroupView = (function() {
    function GroupView(_at_parentElem, _at_elNum) {
      this.parentElem = _at_parentElem;
      this.elNum = _at_elNum != null ? _at_elNum : 1;
      this.elID = this.elName + this.elNum;
    }
  ...
  GenomeController = (function() {
    ...
    function GenomeController(_at_public_genomes, _at_private_genomes, subset) {
  ...
  LocusController = (function() {
    function LocusController(_at_locusData) {
      this.locusData = _at_locusData;
    }
  ...
  StxController = (function() {
    function StxController(_at_locusData) {
      this.locusData = _at_locusData;
      this.dataValues = {};
      this.format();
    }
  ...
  SelectionView = (function() {
    function SelectionView(_at_parentElem, _at_countElem, _at_elNum) {
      this.parentElem = _at_parentElem;
      this.countElem = _at_countElem != null ? _at_countElem : null;
      this.elNum = _at_elNum != null ? _at_elNum : 1;
      this.elID = this.elName + this.elNum;
      this.count = 0;
    }
  ...
  MsaView = (function(_super) {
    ...
    function MsaView(_at_parentElem, _at_style, _at_elNum, msaArgs) {
      var alignmentJSON;
      this.parentElem = _at_parentElem;
      this.style = _at_style;
      this.elNum = _at_elNum;
  ...
  TickerTemplate = (function() {
    function TickerTemplate(_at_parentElem, _at_elNum) {
      this.parentElem = _at_parentElem;
      this.elNum = _at_elNum != null ? _at_elNum : 1;
      this.elID = this.elName + this.elNum;
    }
  ...
  MetaTicker = (function(_super) {
    ...
    function MetaTicker(_at_parentElem, _at_elNum, tickerArgs) {
      this.parentElem = _at_parentElem;
      this.elNum = _at_elNum;
  ...
  StxTicker = (function(_super) {
    ...
    function StxTicker(_at_parentElem, _at_elNum, tickerArgs) {
      this.parentElem = _at_parentElem;
      this.elNum = _at_elNum;
  ...
  MatrixTicker = (function(_super) {
    ...
    function MatrixTicker(_at_parentElem, _at_elNum, genomes, tickerArgs) {
  ...
  AlleleTicker = (function(_super) {
    ...
    function AlleleTicker(_at_parentElem, _at_elNum, tickerArgs) {
      this.parentElem = _at_parentElem;
      this.elNum = _at_elNum;
  ...
  MatrixView = (function(_super) {
    ...
    function MatrixView(_at_parentElem, _at_style, _at_elNum, genomes, matrixArgs) {
  ...
  TableView = (function(_super) {
    ...
    function TableView(_at_parentElem, _at_style, _at_elNum, tableArgs) {
      this.parentElem = _at_parentElem;
      this.style = _at_style;
      this.elNum = _at_elNum;
  ...
  MapView = (function(_super) {
    ...
    function MapView(_at_parentElem, _at_style, _at_elNum, _at_genomeController, _at_mapArgs) {
      ...
      this.style = _at_style;
      this.elNum = _at_elNum;
      this.genomeController = _at_genomeController;
      this.mapArgs = _at_mapArgs;
  ...
  SelectionMapView = (function(_super) {
    ...
    function SelectionMapView(_at_selParentElem, _at_selStyle, _at_selElNum, _at_selGenomeController, _at_selMapArgs) {
      this.selParentElem = _at_selParentElem;
      this.selStyle = _at_selStyle;
      this.selElNum = _at_selElNum;
      this.selGenomeController = _at_selGenomeController;
      this.selMapArgs = _at_selMapArgs;
  ...
  Cartographer = (function() {
    function Cartographer(_at_cartographDiv, _at_cartograhOpt) {
      this.cartographDiv = _at_cartographDiv;
      this.cartograhOpt = _at_cartograhOpt;
  ...
  DotCartographer = (function(_super) {
    ...
    function DotCartographer(_at_dotCartographDiv, _at_dotCartograhOpt) {
      this.dotCartographDiv = _at_dotCartographDiv;
      this.dotCartograhOpt = _at_dotCartograhOpt;
  ...
  SatelliteCartographer = (function(_super) {
    ...
    function SatelliteCartographer(_at_satelliteCartographDiv, _at_satelliteCartograhOpt) {
      this.satelliteCartographDiv = _at_satelliteCartographDiv;
      this.satelliteCartograhOpt = _at_satelliteCartograhOpt;
  ...
  GeophyCartographer = (function(_super) {
    ...
    function GeophyCartographer(_at_geophyCartographDiv, _at_geophyCartograhOpt) {
      this.geophyCartographDiv = _at_geophyCartographDiv;
      this.geophyCartograhOpt = _at_geophyCartograhOpt;
  ...
  InfoSatelliteCartographer = (function(_super) {
    ...
    function InfoSatelliteCartographer(_at_infoSatelliteCartographDiv, _at_infoSatelliteCartograhOpt) {
      var _ref;
      this.infoSatelliteCartographDiv = _at_infoSatelliteCartographDiv;
      this.infoSatelliteCartograhOpt = _at_infoSatelliteCartograhOpt;
  ...
  CartographerOverlay = (function() {
    function CartographerOverlay(_at_map, _at_latLng, _at_title) {
      this.map = _at_map;
      this.latLng = _at_latLng;
  ...
  LocationController = (function() {
    function LocationController(_at_genomeController, _at_parentElem, _at_viewNum) {
      this.genomeController = _at_genomeController;
      this.parentElem = _at_parentElem;
      this.viewNum = _at_viewNum;
