...
(function() {
  ...
  SuperphyMenu = (function() {
    function SuperphyMenu(_at_menuElem, _at_affix2Elem, _at_pageName, _at_menuName, _at_searchList, _at_viewList, _at_searchUrl, _at_redirectSearch) {
      var _ref, _ref1;
      this.menuElem = _at_menuElem;
      this.affix2Elem = _at_affix2Elem;
      this.pageName = _at_pageName;
      this.menuName = _at_menuName;
      this.searchList = _at_searchList;
      this.viewList = _at_viewList;
      this.searchUrl = _at_searchUrl;
      this.redirectSearch = _at_redirectSearch != null ? _at_redirectSearch : false;
      if (!this.menuElem) {
