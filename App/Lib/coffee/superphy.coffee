...
class ViewController
  ...
  metaForm: (elem, parentStr) ->
    ...
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="serotype"> Serotype </label><div id="meta-option_serotype" style="width:12px;height:12px;background:#236932;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="isolation_host"> Isolation Host </label><div id="meta-option_isolation_host" style="width:12px;height:12px;background:#9E0015;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="isolation_source"> Isolation Source </label><div id="meta-option_isolation_source" style="width:12px;height:12px;background:#000752;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+
    ...
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="syndrome"> Symptoms / Diseases </label><div id="meta-option_syndrome" style="width:12px;height:12px;background:#520042;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="stx1_subtype"> Stx1 Subtype </label><div id="meta-option_stx1_subtype" style="width:12px;height:12px;background:#F05C00;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+
    '<div class="checkbox col-md-12"><label><input class="meta-option checkbox" type="checkbox" name="meta-option" value="stx2_subtype"> Stx2 Subtype </label><div id="meta-option_stx2_subtype" style="width:12px;height:12px;background:#006B5C;border:0.5px solid #000;position:relative;bottom:15px;left:200px;"></div></div>'+                                                   
    '</fieldset>'+
    '</form>'+
    '</div></div>'
