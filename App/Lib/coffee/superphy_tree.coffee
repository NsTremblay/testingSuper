          ...
          rect_block
            ...
            .attr("data-content", (n)->
              ...
              if i is 6
                ...
                else tt_data = n.tt_mtype[m].slice(0, n.tt_mtype[m].indexOf(n.to_be_hl)) + "<tr class='table-row-bold' style='color:" + colours[m][4] + "'><td>" + n.to_be_hl
              "<table class='popover-table'><tr><th style='width:160px;text-align:left'>" + tt_mtitle + "</th><th style='min-width:110px;text-align:right'># of Genomes</th></tr>" + tt_data + "</table>")
          i++
